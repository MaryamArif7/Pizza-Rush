  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      try {
        ...
        console.log("Could not reset ",error)
      }
    },
  });
  ...
  return (
    <div className="container mx-auto">
      ...
      <div className="flex justify-center items-center h-screen">
        <div
          className="bg-[rgba(255,255,255,0.55)] rounded-[16px] shadow-[0_4px_30px_rgba(71,71,71,0.11)] backdrop-blur-[7.1px]  border-[rgba(255,255,255,0.3)] border-4 border-gray-50 shrink-0 h-[75%] w-[30%]  py-20 px-7 min-w-max"
          style={{ width: "50%" }}
        >
